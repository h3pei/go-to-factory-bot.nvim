describe("ModelPathAnalyzer", function()
  ...
  describe("extract_model_info", function()
    it("extracts model name from simple path", function()
      local model_name, subdirectory, error_message = ModelPathAnalyzer.extract_model_info("app/models/user.rb")
    ...
    it("extracts model name and subdirectory from nested path", function()
      local model_name, subdirectory, error_message = ModelPathAnalyzer.extract_model_info("app/models/admin/user.rb")
      assert.equals(model_name, "user")
    ...
    it("extracts model name and deep subdirectory", function()
      local model_name, subdirectory, error_message = ModelPathAnalyzer.extract_model_info("app/models/api/v1/user.rb")
      assert.equals(model_name, "user")
    ...
    it("returns error for concerns directory", function()
      local model_name, subdirectory, error_message = ModelPathAnalyzer.extract_model_info("app/models/concerns/taggable.rb")
      assert.is_nil(model_name)
      assert.is_nil(subdirectory)
      assert.equals(error_message, "This file is not associated with a factory file")
    end)

    it("returns error for application_record.rb", function()
      local model_name, subdirectory, error_message = ModelPathAnalyzer.extract_model_info("app/models/application_record.rb")
      assert.is_nil(model_name)
      assert.is_nil(subdirectory)
      assert.equals(error_message, "This file is not associated with a factory file")
    end)
    ...
    it("returns error for non-model file", function()
      local model_name, subdirectory, error_message = ModelPathAnalyzer.extract_model_info("app/controllers/users_controller.rb")
      assert.is_nil(model_name)
      assert.is_nil(subdirectory)
